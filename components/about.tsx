...
export function About() {
  ...
  const defaultInfo = {
    ...
    experienceCards: [{"icon":"briefcase","title":"우주디자인컴퍼니(주)","period":"현재","description":"대표이사"},{"icon":"graduation","title":"단국대학교 부동산 건설대학원","period":"2024 - 현재","description":"도시 및 부동산개발"},{"icon":"award","title":"주요업무","period":"건설업,부동산업, 일반음식점영업, 카페,외식업, 무인사진관","description":"설명을 입력하세요"},{"icon":"graduation","title":"경기대학교 예술대학원","period":"현재","description":"서양화과"}],
